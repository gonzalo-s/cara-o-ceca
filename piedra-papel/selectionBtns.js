export default function selectionBtns(state, dispatch) {
	...
	btnsWrapper.appendChild(piedraBtn(state, dispatch))
	btnsWrapper.appendChild(papelBtn(state, dispatch))
	btnsWrapper.appendChild(tijeraBtn(state, dispatch))

	return btnsWrapper
}
function piedraBtn(state, dispatch) {
...
function papelBtn(state, dispatch) {
...
function tijeraBtn(state, dispatch) {
